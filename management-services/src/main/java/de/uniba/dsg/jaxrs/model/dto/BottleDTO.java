...
public class BottleDTO {
    ...
    public static List<BottleDTO >marshallPagination(final List<Bottle> bottleList) {
        final ArrayList<BottleDTO> bottles = new ArrayList<>();
        for (final Bottle bottle : bottleList) {

            bottles.add(new BottleDTO(bottle));
        }
        return bottles;
    }
    public static BottleDTO marshall(final Bottle bottle) {
